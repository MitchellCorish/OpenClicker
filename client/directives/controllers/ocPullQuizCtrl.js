(function () {
  ...
  angular
    .module('openClicker')
    .controller('ocPullQuizCtrl', ocPullQuizCtrl);
    
  ocPullQuizCtrl.$inject = ['$scope', '$reactive', 'GroupMembershipService'];
  
  function ocPullQuizCtrl($scope, $reactive, GroupMembershipService) {
    var vm = this;
